filesSF_Hmel201011 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel201011', full.names = T)
filesSF_Hmel210004 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel210004', full.names = T)
filesSF_Hmel215006 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel215006', full.names = T)
filesSF_Hmel218003 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel218003', full.names = T)

filesSF_Hmel204017 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel204017', full.names = T)
filesSF_Hmel206006 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel206006', full.names = T)
filesSF_Hmel208051 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel208051', full.names = T)
filesSF_Hmel219003 <- list.files(path='SF_Markus/NEW_FILES/VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE/', pattern='Hmel219003', full.names = T)
...
pdf('VF_POLSUBALL_75_OM1_IG50_BGSFS_NORECRATE_melp_260919.pdf', width=18, height=19)
...
plot(NULL, xlim=c(start,end), ylim = c(0,1), axes=FALSE,ann=FALSE)
rect((1193549-2000)/1000000, 0, (1195549+1000)/1000000, 1, col = adjustcolor('gray50',alpha=0.5), border = NA) # cr1
rect((1217149-2000)/1000000, 0, (1219149+1000)/1000000, 1, col = adjustcolor('gray50',alpha=0.5), border = NA) # cr2
rect((1323223)/1000000, 0, (1338526)/1000000, 1, col = adjustcolor('gray50',alpha=0.2), border = NA) # FW

# rect(1193549-2000, 0, 1195549+1000, 1, col = adjustcolor('pink', alpha.f = 0.5), border = NA) # cr1
# rect(1217149-2000, 0, 1219149+1000, 1, col = adjustcolor('blue', alpha.f = 0.5), border = NA) # cr2
# rect(start,0,end,1, col = adjustcolor('gray', 0.5), border = adjustcolor('gray', 0.5))
...
# 
#   maxalpha <- max(max(1/(as.numeric(as.character(tableSFHmel201011$alpha))*1000000)),
#               max(1/(as.numeric(as.character(tableSFHmel210004$alpha))*1000000)),
#               max(1/(as.numeric(as.character(tableSFHmel215006$alpha))*1000000)),
#               max(1/(as.numeric(as.character(tableSFHmel218003$alpha))*1000000)))
# 
...
#   tableSFHmel218003 <- as.data.frame(t(sapply(split(tableSFHmel218003, as.integer(gl(nrow(tableSFHmel218003), 10, nrow(tableSFHmel218003)))), colMeans, na.rm = TRUE)))
# 
#   maxD <- min(min(as.numeric(as.character(tableSFHmel201011$D))),
#               min(as.numeric(as.character(tableSFHmel210004$D))),
#               min(as.numeric(as.character(tableSFHmel215006$D))),
#               min(as.numeric(as.character(tableSFHmel218003$D))))
# 
#   maxDs <- c(maxDs,maxD)
#   }
# 
...
library(wesanderson)
colsD <- wes_palette("Zissou1", 100, type = "continuous")
...
for(e in 1:length(popsSF)){
  ...
  tableSFHmel201011$alpha <- sapply(1/(as.numeric(as.character(tableSFHmel201011$alpha))*1000000), function(x) ifelse(x > 0.1, 0.1, x))
  tableSFHmel201011$col <-colfuncR(101)[as.integer((tableSFHmel201011$alpha)*1000)+1]
  ...
  points(subT$location/1000000, rep(1100, nrow(subT)), pch=15, col=colsD[round(((subT$D-minD)/(maxD-minD))*100)], cex=0.5)
  ...
  tableSFHmel210004$alpha <- sapply(1/(as.numeric(as.character(tableSFHmel210004$alpha))*1000000), function(x) ifelse(x > 0.1, 0.1, x))
  tableSFHmel210004$col <-colfuncR(101)[as.integer((tableSFHmel210004$alpha)*1000)+1]
  ...
  rect((1193549-2000)/1000000, 0, (1195549+1000)/1000000, 1000, col = 'gray85', border = NA) # cr1
  rect((1217149-2000)/1000000, 0, (1219149+1000)/1000000, 1000, col = 'gray85', border = NA) # cr2
  ...
  tableSFHmel215006$alpha <- sapply(1/(as.numeric(as.character(tableSFHmel215006$alpha))*1000000), function(x) ifelse(x > 0.1, 0.1, x))
  tableSFHmel215006$col <-colfuncR(101)[as.integer((tableSFHmel215006$alpha)*1000)+1]
  ...
  tableSFHmel218003$alpha <- sapply(1/(as.numeric(as.character(tableSFHmel218003$alpha))*1000000), function(x) ifelse(x > 0.1, 0.1, x))
  tableSFHmel218003$col <-colfuncR(101)[as.integer((tableSFHmel218003$alpha)*1000)+1]
