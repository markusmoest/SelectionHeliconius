...
################
library(readxl)
table <- read.csv("Fig2/simulation_summaries.csv", h=T)
...
allgens_tajD_p2 <- read.csv("Fig2/Classic_sweep_CLR_overtime.csv", header=FALSE)
...
allgens_tajD_p2 <- read.csv("Fig2/Introgressed_sweep_CLR_overtime.csv", header=FALSE)
# attach(allgens_tajD_p2)
...
allgens_tajD_p2 <- read.csv("Fig2/Classic_sweep_TajimaD_overtime.csv", header=FALSE)
# attach(allgens_tajD_p2)
...
allgens_tajD_p2 <- read.csv("Fig2/Introgressed_sweep_TajimaD_overtime.csv", header=FALSE)
# attach(allgens_tajD_p2)
