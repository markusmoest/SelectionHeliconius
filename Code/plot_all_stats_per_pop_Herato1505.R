...
for(e in 1:length(pops)){
  ...
  png(filename=paste("C:/Users/vanbe/Dropbox (Personal)/Manuscript_Selection/Figures/Suppl_stats_erato/Herato1505_",names[e], ".png", sep=""), width = 1000, height = 1000)
  
  print(pops[e])
  
  indxSF <- grep(popsSF[e], filesSF_Herato1505)
  indxEHH <- grep(popsSF[e], filesEHH_Herato1505)
  indxStats <- grep(pops[e], filesStats_Herato1505)
  indxGenoPS <- grep(pops[e], filesGenoPS_Herato1505)
  
  tableSF <- read.table(filesSF_Herato1505[indxSF], h=T, stringsAsFactors=F)
  tableEHH <- read.table(filesEHH_Herato1505[indxEHH], h=T, stringsAsFactors=F)
  tableStats <- read.csv(filesStats_Herato1505[indxStats], h=T, stringsAsFactors=F)
  tableGenoPS <- read.csv(filesGenoPS_Herato1505[indxGenoPS], h=T, stringsAsFactors=F)
  ...
  ANNOT2 <- read.table("gff/Herato1505_cortex_fixed.txt",sep="\t")
  names(ANNOT2) <- c("contig", "HGC", "type", "con_start", "con_end", "dot", "str", "unk", "descr")
  
  newCol <- colsplit(ANNOT$descr,";",c('ID','Name'))
  newCol$ID <- gsub("ID=evm.TU.Herato1505.", "", newCol$ID)
  
  ANNOT <- cbind(ANNOT, newCol)
  ...
  # rect(2074221/1000000, 0, 2087632/1000000, 1.2, col = adjustcolor('gray', 0.5), border = NA)
  ...
  rect(2053037/1000000, 0, 2171230/1000000, 1, density = NULL, angle = 45, col = adjustcolor("orange",alpha=0.3), border = "orange", lty = par("lty"), lwd = par("lwd"))
  rect(2211881/1000000, 0, 2315926/1000000, 1, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  # rect(2074221/1000000, 0, 2087632/1000000, 0.06, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray') 
  
  rect(2053037/1000000, 0, 2171230/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("orange",alpha=0.3), border = "orange", lty = par("lty"), lwd = par("lwd"))
  rect(2211881/1000000, 0, 2315926/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  # rect(2074221/1000000, -3, 2087632/1000000, 3, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray') 
  
  rect(2053037/1000000, -3, 2171230/1000000, 3, density = NULL, angle = 45, col = adjustcolor("orange",alpha=0.3), border = "orange", lty = par("lty"), lwd = par("lwd"))
  rect(2211881/1000000, -3, 2315926/1000000, 3, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  # rect(2074221/1000000, 0, 2087632/1000000, 26, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray')
  
  rect(2053037/1000000, 0, 2171230/1000000, 26, density = NULL, angle = 45, col = adjustcolor("orange",alpha=0.3), border = "orange", lty = par("lty"), lwd = par("lwd"))
  rect(2211881/1000000, 0, 2315926/1000000, 26, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  rect(2053037/1000000, 0, 2171230/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("orange",alpha=0.3), border = "orange", lty = par("lty"), lwd = par("lwd"))
  rect(2211881/1000000, 0, 2315926/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
