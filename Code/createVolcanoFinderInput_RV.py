...
###***********************************************************************************************
###
### This script generates the input for VolcanoFinder (and/or SweepFinder).
...
### with the name POP_SCAF.volcanofinder.input
###
###***********************************************************************************************
###
...
###
### WARNIGNG: USE ONLY ONE POP (with or without) OUTGROUP
###
...
for pop in pops:
  if allAsOne: # when no scaffolds are indicated
    vars()[pop] = open(outPref + "." + pop + ".volcanofinder.input", "w") #creates file
    vars()[pop].write("position\tx\tn\tfolded\n") # writes header to file
  else:
    for scaf in scafs: # when scafolds are indicated
      vars()[pop + scaf] = open(outPref + "." + pop + "_" + scaf + ".volcanofinder.input", "w")
