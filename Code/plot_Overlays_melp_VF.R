...
allmelcladeHQ <- c("Mama_all_filtered_","Mcyt_C_filtered_","Mecu_C_filtered_","MmalC_all_filtered_","MmalE_all_filtered_", "MmelC_all_filtered_","MmelG_HQ1_filtered_","MmelP_all_filtered_","Mmer_C_HQ_filtered_","Mnan_all_NORTH_filtered_","Mnan_all_SOUTH_filtered_","Mple_all_filtered_","Mros_filtered_","Mvul_filtered_", "Mxen_C_filtered_", "Cchi_filtered_", "Ccor_filtered_", "Ccyd_C_filtered_", "Cweyg_C_filtered_", "Cweyw_C_filtered_", "Czel_filtered_","PAC_C_HQ_filtered_", "Tflo_all_filtered_", "Tlin_C_filtered_", "TspnE_C_filtered_","Tthe_all_filtered_", "Ttimc_C_filtered_", "Ttimt_C_filtered_", "Tvic_C_filtered_", "HEU_all_filtered_", "ELE_C_Ecu_filtered_", "BES_C_filtered_")

melWEST <- c("Mcyt_C_filtered_","MmelP_all_filtered_","Mros_filtered_","Mvul_filtered_")

melEAST <- c("Mama_all_filtered_","Mecu_C_filtered_","MmalC_all_filtered_","MmalE_all_filtered_", "MmelC_all_filtered_","MmelG_HQ1_filtered_","Mmer_C_HQ_filtered_","Mnan_all_NORTH_filtered_","Mnan_all_SOUTH_filtered_","Mple_all_filtered_")
...
svg("Overlays_mel_VF.svg", width=14, height=8, pointsize = 12)
###set layout###
