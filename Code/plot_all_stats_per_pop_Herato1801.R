...
for(e in 1:length(pops)){
  ...
  png(filename=paste("C:/Users/vanbe/Dropbox (Personal)/Manuscript_Selection/Figures/Suppl_stats_erato/Herato1801_",names[e], ".png", sep=""), width = 1000, height = 1000)
  
  print(pops[e])
  
  indxSF <- grep(popsSF[e], filesSF_Herato1801)
  indxEHH <- grep(popsSF[e], filesEHH_Herato1801)
  indxStats <- grep(pops[e], filesStats_Herato1801)
  indxGenoPS <- grep(pops[e], filesGenoPS_Herato1801)
  
  tableSF <- read.table(filesSF_Herato1801[indxSF], h=T, stringsAsFactors=F)
  tableEHH <- read.table(filesEHH_Herato1801[indxEHH], h=T, stringsAsFactors=F)
  tableStats <- read.csv(filesStats_Herato1801[indxStats], h=T, stringsAsFactors=F)
  tableGenoPS <- read.csv(filesGenoPS_Herato1801[indxGenoPS], h=T, stringsAsFactors=F)
  ...
  ANNOT2 <- read.table("gff/Herato1801_optix.gff",sep="\t")
  ...
  # rect(1250413/1000000, 0, 1251203/1000000, 1.2, col = adjustcolor('gray', 0.5), border = NA)
  ...
  # rect(1350722/1000000, 0, 1484983/1000000, 1, density = NULL, angle = 45, col = "gray", border = "gray", lty = par("lty"), lwd = par("lwd"))
  rect(1377801/1000000, 0, 1384841/1000000, 1, density = NULL, angle = 45, col = adjustcolor("red",alpha=0.3), border = "red", lty = par("lty"), lwd = par("lwd"))
  rect(1412888/1000000, 0, 1419375/1000000, 1, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1422585/1000000, 0, 1428307/1000000, 1, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1403328/1000000, 0, 1403691/1000000, 1, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  rect(1420912/1000000, 0, 1422355/1000000, 1, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  text(1.7,0.2, substitute(paste(italic(nn)), list(nn=names[e])), cex=2)
  ...
  # rect(1250413/1000000, 0, 1251203/1000000, 0.06, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray') 
  
  rect(1377801/1000000, 0, 1384841/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("red",alpha=0.3), border = "red", lty = par("lty"), lwd = par("lwd"))
  rect(1412888/1000000, 0, 1419375/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1422585/1000000, 0, 1428307/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1403328/1000000, 0, 1403691/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  rect(1420912/1000000, 0, 1422355/1000000, 0.06, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  # rect(1250413/1000000, -3, 1251203/1000000, 3, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray') 
  
  rect(1377801/1000000, -3, 1384841/1000000, 3, density = NULL, angle = 45, col = adjustcolor("red",alpha=0.3), border = "red", lty = par("lty"), lwd = par("lwd"))
  rect(1412888/1000000, -3, 1419375/1000000, 3, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1422585/1000000, -3, 1428307/1000000, 3, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1403328/1000000, -3, 1403691/1000000, 3, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  rect(1420912/1000000, -3, 1422355/1000000, 3, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  # rect(1250413/1000000, 0, 1251203/1000000, 26, col = adjustcolor('gray', 0.5), border = NA)
  abline(h=0, col='lightgray')
  
  rect(1377801/1000000, 0, 1384841/1000000, 26, density = NULL, angle = 45, col = adjustcolor("red",alpha=0.3), border = "red", lty = par("lty"), lwd = par("lwd"))
  rect(1412888/1000000, 0, 1419375/1000000, 26, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1422585/1000000, 0, 1428307/1000000, 26, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1403328/1000000, 0, 1403691/1000000, 26, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  rect(1420912/1000000, 0, 1422355/1000000, 26, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  ...
  rect(1377801/1000000, 0, 1384841/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("red",alpha=0.3), border = "red", lty = par("lty"), lwd = par("lwd"))
  rect(1412888/1000000, 0, 1419375/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1422585/1000000, 0, 1428307/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("black",alpha=0.3), border = "black", lty = par("lty"), lwd = par("lwd"))
  rect(1403328/1000000, 0, 1403691/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
  rect(1420912/1000000, 0, 1422355/1000000, 1000, density = NULL, angle = 45, col = adjustcolor("yellow",alpha=0.3), border = "yellow", lty = par("lty"), lwd = par("lwd"))
